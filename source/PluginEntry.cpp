/**
	...
	`CFFGLPluginInfo` that Colourunder.cpp registers at static-initialisation
	...
	binary: which build it is.
		...
		strings Colourunder.bundle/Contents/MacOS/Colourunder | grep colourunder
*/

extern "C" const char* ColourunderBuildStamp()
{
	return "colourunder " COLOURUNDER_VERSION " built " __DATE__ " " __TIME__;
}
